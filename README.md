...
sudo apt-get install --no-install-recommends \
    git build-essential libssl-dev zlib1g-dev libbz2-dev libreadline-dev python3.7-dev \
...
./pyenv-installer
~/.pyenv/bin/pyenv install 3.7.9
~/.pyenv/versions/3.7.9/bin/python -m venv ~/gs-venv
